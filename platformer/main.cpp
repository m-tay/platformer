...
void initLevel2() {
	...
	game.levelMap += "D------####--------------------------------###-----------------D";
	game.levelMap += "D--------------------------------------------------------------D";
	game.levelMap += "D-b1---------------------------------------------1---bw--------D";
	game.levelMap += "D####-----------------------------b-------------#########------D";
	game.levelMap += "D-------e----------------------#####-------------------------1-D";
	game.levelMap += "D----#####--------------------------------------------------###D";
...
void initLevel3() {
	...
	game.levelMap += "D---------------------w-----1----------------1b1------#########D";
	game.levelMap += "D--------------------###--------------------#####--------------D";
	game.levelMap += "Dq1-------------------------1--------------#DDDD---------------D";
	game.levelMap += "D###-----------------------###---------b---------------------d-D";
	game.levelMap += "D--------b1---------------------------###---------------e---###D";
	...
	game.levelMap += "D--------######------------------------------------------------D";
	game.levelMap += "D-1------------------------b-----------------b---------------1-D";
	game.levelMap += "D###------------------########-------------####-------------###D";
	game.levelMap += "D-------------------------------------##-----------------------D";
	game.levelMap += "D---------w-##----##--b------##----###DD####----##-------b-----D";
